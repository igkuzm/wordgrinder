...
local function export_docx_with_ui(filename, title, extension)
	...
	styles = styles .. string_format('<w:style w:type="paragraph" w:styleId="RIGHT"><w:name w:val="RIGHT"/><w:qFormat/><w:pPr><w:widowControl w:val="false"/><w:bidi w:val="0"/><w:spacing w:before="85" w:after="85"/><w:jc w:val="right"/></w:pPr><w:rPr><w:rFonts w:ascii="Times New Roman" w:hAnsi="Times New Roman"/><w:sz w:val="%d"/><w:lang w:val="ru-RU" w:eastAsia="zh-CN" w:bidi="hi-IN"/></w:rPr></w:style>', settings.fontsize * 2)
